...
// 1. Яка кількість смиволів повинна бути в інпуті, зазначається в його атрибуті data-length.
...
inputEl.addEventListener("blur", () => {
  ...
  if (
    inputEl.value.length >= Number.parseInt(inputEl.getAttribute("data-length"))
  ) {
